 ...
 * @author JPEXS
 */
public class InCallFunction extends InDebuggerMessage {
    ...
    public String toString() {
        return super.toString() + "(items.count=" + parentsIds.size() + ")";
    }

    public InCallFunction(DebuggerConnection c, byte[] data) {
        super(c, ID, data);
