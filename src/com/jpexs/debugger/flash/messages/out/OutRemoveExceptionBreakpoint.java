 ...
 * @author JPEXS
 */
public class OutRemoveExceptionBreakpoint extends OutDebuggerMessage {
    ...
    public OutRemoveExceptionBreakpoint(DebuggerConnection c, String exceptionClass) {
        super(c, ID);
        this.exceptionClass = exceptionClass;
        //receive InRemoveExceptionBreakpoint
    }
